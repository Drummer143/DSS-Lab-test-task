...
console.log(`decode(encodedMessage):\n${decode(encodedMessage)}`); // = .4-2.4-1.4-6.1-4.2-4.1-12.1-4.2-12.1-2.1-4.2-18.1-4.4-1.4-2.18-1.6-1.4-4.4-1.8-1.4-4.6-1.16-1.4-4.12-1.4-8.1-4.4-16.1-18.1-4.4-18.1-10.1-4.6-6.1-4.2-1.4-6.6-1.20-1.8-6.1-4.1-8.6-1.14
console.log(`decode(decode(encodedMessage)):\n${decode(decode(encodedMessage))}`); // = i love puzzles
